...
namespace StudentManagementSystem.Migrations
{
    ...
    [Migration("20251126092428_EnhancedAcademicSystemWithSemesterProperties")]
    partial class EnhancedAcademicSystemWithSemesterProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentManagementSystem.Models.Course", b =>
                {
                    ...
                    b.ToTable("Courses", t =>
                        {
                            t.HasCheckConstraint("CK_Course_Credits", "[Credits] > 0 AND [Credits] <= 6");
                        });
                });
            ...
            modelBuilder.Entity("StudentManagementSystem.Models.CourseEnrollment", b =>
                {
                    ...
                    b.Property<string>("GradeRevisionReason")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<bool>("GradeRevisionRequested")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<string>("GradeRevisionStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.ToTable("CourseEnrollments", t =>
                        {
                            t.HasCheckConstraint("CK_CourseEnrollment_AssignmentAverage", "[AssignmentAverage] IS NULL OR ([AssignmentAverage] >= 0 AND [AssignmentAverage] <= 100)");

                            t.HasCheckConstraint("CK_CourseEnrollment_Attendance", "[AttendancePercentage] IS NULL OR ([AttendancePercentage] >= 0 AND [AttendancePercentage] <= 100)");

                            t.HasCheckConstraint("CK_CourseEnrollment_Grade", "[Grade] IS NULL OR ([Grade] >= 0 AND [Grade] <= 100)");

                            t.HasCheckConstraint("CK_CourseEnrollment_WaitlistPosition", "[WaitlistPosition] IS NULL OR [WaitlistPosition] > 0");
                        });
                });
            ...
            modelBuilder.Entity("StudentManagementSystem.Models.GradeScale", b =>
                {
                    ...
                    b.ToTable("GradeScales", t =>
                        {
                            t.HasCheckConstraint("CK_GradeScale_GradePoints", "[GradePoints] >= 0 AND [GradePoints] <= 4.00");

                            t.HasCheckConstraint("CK_GradeScale_PercentageRange", "[MinPercentage] >= 0 AND [MaxPercentage] <= 100 AND [MinPercentage] <= [MaxPercentage]");
                        });
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2090),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2239),
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2252),
                            Description = "Excellent",
                            GradeLetter = "A-",
                            GradePoints = 3.7m,
                            IsActive = true,
                        ...
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2263),
                            Description = "Good",
                            GradeLetter = "B+",
                            GradePoints = 3.3m,
                            IsActive = true,
                        ...
                        {
                            Id = 5,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2269),
                            Description = "Good",
                            GradeLetter = "B",
                            GradePoints = 3.0m,
                            IsActive = true,
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2287),
                            Description = "Good",
                            GradeLetter = "B-",
                            GradePoints = 2.7m,
                            IsActive = true,
                        ...
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2340),
                        ...
                        {
                            Id = 8,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2350),
                            Description = "Satisfactory",
                            GradeLetter = "C",
                            GradePoints = 2.0m,
                            IsActive = true,
                        ...
                        {
                            Id = 9,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2375),
                            Description = "Satisfactory",
                            GradeLetter = "C-",
                            GradePoints = 1.7m,
                            IsActive = true,
                        ...
                        {
                            Id = 10,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2388),
                            Description = "Poor",
                            GradeLetter = "D+",
                            GradePoints = 1.3m,
                            IsActive = true,
                        ...
                        {
                            Id = 11,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2406),
                            Description = "Poor",
                            GradeLetter = "D",
                            GradePoints = 1.0m,
                            IsActive = true,
                        ...
                        {
                            Id = 12,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2417),
                            Description = "Poor",
                            GradeLetter = "D-",
                            GradePoints = 0.7m,
                            IsActive = true,
                        ...
                        {
                            Id = 13,
                            CreatedDate = new DateTime(2025, 11, 26, 11, 24, 26, 322, DateTimeKind.Local).AddTicks(2424),
                            Description = "Failure",
                            GradeLetter = "F",
                            GradePoints = 0.0m,
                            IsActive = true,
            ...
            modelBuilder.Entity("StudentManagementSystem.Models.Semester", b =>
                {
                    ...
                    b.Property<bool>("IsGradingPeriod")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
                    ...
                    b.Property<bool>("IsRegistrationPeriod")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
